...
namespace GameState.Installers {
    ...
    /// It ensures that the <see cref="GameStateFactory"/> has visibility over the scene context in order to resolve
    /// such game states.
    /// </summary>
    public abstract class AbstractGameStateMonoInstaller : MonoInstaller {
